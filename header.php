               ...
               <div class="tp-preloader-logo">
                  <div class="tp-preloader-circle">
                     <svg width="190" height="190" viewBox="0 0 380 380" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle stroke="" cx="190" cy="190" r="180" stroke-width="6" stroke-linecap="round"></circle>
                     </svg>
                  </div>
                  <img src="assets/img/logo/preloader/vest.png" width="150px" alt="">
               </div>
               <!-- <h3 class="tp-preloader-title">VESTIDO</h3> -->
            ...
            <div class="offcanvas__contact align-items-center d-none">
               ...
               <div class="offcanvas__contact-content">
                  <h3 class="offcanvas__contact-title">
                     <a href="tel:098-852-987">+971 52 706 1545</a>
                  </h3>
               </div>
            </div>
         ...
         <div class="row row-cols-2">
            <div class="col">
               <div class="tp-mobile-item text-center">
                  <a href="index.php" class="tp-mobile-item-btn">
            ...
            <div class="col">
               <div class="tp-mobile-item text-center">
                  <a href="https://wa.me/+971563153483?text" class="tp-mobile-item-btn">
               ...
               <div class="tp-mega-menu-wrapper p-relative">
                  <div class="row align-items-center">
                     ...
                     <div class="col-xl-10 d-none d-xl-block ">
                        <div class="main-menu menu-style-2" style="float:right !important">
                           <nav class="tp-main-menu-content ">
                              <ul>
                                 ...
                                 <li class="has-dropdown">
                                    <a >Products</a>
                                    <ul class="tp-submenu">
                                       <li><a href="products.php?category=All">All</a></li>
                                       <?php
															$i = 1;
