	...
	<header class="ec-main-header" id="header">
		<nav class="navbar navbar-static-top ">
			...
			<button id="sidebar-toggler" class="sidebar-toggle"><i class="mdi mdi-view-dashboard"></i></button>
			<!-- search form -->
    ...
    <a href="../controller/logout.php" class="nav-link ec-drop" title="Logout">
        <i style="font-size: x-large; margin-right: 10px;" class="mdi mdi-power"></i>
    </a>
</li>
