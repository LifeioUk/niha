...
<body class="ec-header-fixed ec-sidebar-fixed ec-sidebar-dark ec-header-light" id="body">
									...
									<div class="row ec-vendor-uploads">
										...
										<div class="col-lg-8">
											<div class="ec-vendor-upload-detail">
												<form class="row g-3" action="../controller/product-edit.php" method="POST" enctype="multipart/form-data">
													<div class="col-md-6">
														<label for="inputEmail4" class="form-label">Product name</label>
														<input type="text" required value="<?= $row['p_name'] ?>" name="productname" class="form-control slug-title" id="inputEmail4">
														<input type="hidden" value="<?= $row['p_id'] ?>" name="product_id" class="form-control slug-title" id="inputEmail4">
													</div>
													<div class="col-md-6">
													...
													<div class="col-md-6 mb-25">
														...
														<div class="form-checkbox-box">
															<div class="form-check form-check-inline">
																<input type="radio" name="gender" required value="Male" <?php echo ($row['p_gender'] === 'Male') ? 'checked' : ''; ?>>
																<label>Male</label>
															</div>

															<div class="form-check form-check-inline">
																<input type="radio" name="gender" required value="Female" <?php echo ($row['p_gender'] === 'Female') ? 'checked' : ''; ?>>
																<label>Female</label>
															</div>
														</div>
													</div>
													...
													<div id="color-picker">
														...
														<input type="hidden" class="form-control" name="p_color"  id="selected-colors" readonly>
													</div>
													...
													<script>
														...
														let selectedColors = <?= json_encode($colorsArray) ?>; // Replace with the fetched colors

														// Call the functions to initialize the UI
														updateColorEntries();
    ...
    // Filter out empty strings from the selectedColors array
    const filteredColors = selectedColors.filter((color) => color !== '');

    if (filteredColors.length === 0) {
        const noColorsMessage = document.createElement('p');
        noColorsMessage.textContent = 'No colors selected.';
        colorEntriesContainer.appendChild(noColorsMessage);
    } else {
        filteredColors.forEach((colorCode) => {
            ...
            colorEntriesContainer.appendChild(colorEntry);
													...
													<div class="col-md-12">
														...
														<textarea class="form-control" name="description" rows="4"><?= $row['p_desc'] ?></textarea>
													</div>
												...
												<div class="ec-vendor-main-img">
													<div class="avatar-upload">
														<div class="avatar-edit">
															<input type='file' id="imageUpload" name="image1" class="ec-image-upload" accept=".png, .jpg, .jpeg" />
															<label for="imageUpload"><img src="assets/img/icons/edit.svg" class="svg_img header_svg" alt="edit" /></label>
														</div>
														<div class="avatar-preview ec-preview">
															<div class="imagePreview ec-div-preview">
																<img class="ec-image-preview" src="../controller/<?= $row['p_image1'] ?>" alt="edit" />
															</div>
														</div>
													</div>
														...
														<div class="thumb-upload">
															...
															<div class="thumb-preview ec-preview">
																<div class="image-thumb-preview">
																	<img style="object-fit: cover;overflow:hidden" class="image-thumb-preview ec-image-preview" src="../controller/<?= $row['p_image2'] ?>" alt="edit" />
																</div>
															</div>
														</div>
														<div class="thumb-upload">
															...
															<div class="thumb-preview ec-preview">
																<div class="image-thumb-preview">
																	<img style="object-fit: cover;overflow:hidden" class="image-thumb-preview ec-image-preview" src="../controller/<?= $row['p_image3'] ?>" alt="edit" />
																</div>
															</div>
														</div>
														<div class="thumb-upload">
															...
															<div class="thumb-preview ec-preview">
																<div class="image-thumb-preview">
																	<img style="object-fit: cover;overflow:hidden" class="image-thumb-preview ec-image-preview" src="../controller/<?= $row['p_image4'] ?>" alt="edit" />
																</div>
															</div>
														</div>
														<div class="thumb-upload">
															...
															<div class="thumb-preview ec-preview">
																<div class="image-thumb-preview">
																	<img class="image-thumb-preview ec-image-preview" style="object-fit: cover;overflow:hidden" src="../controller/<?= $row['p_image5'] ?>" alt="edit" />
																</div>
															</div>
														</div>
