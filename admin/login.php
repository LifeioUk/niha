...
<html lang="en">
	<head>
		...
		<title>Vestido - Admin login </title>
						...
						<div class="card-header bg-primary">
							<div class="ec-brand">
								<a href="index.php" title="Ekka">
									<img class="ec-brand-icon" src="assets/img/logo/vestwhite.png" alt="" />
								</a>
							</div>
						</div>
							...
							<form action="../controller/login.php" method="post">
								<div class="row">
									<div class="form-group col-md-12 mb-4">
										<input type="text"  name="name" class="form-control" id="email" placeholder="Username/email" required>
									</div>
