...
<div class="ec-left-sidebar ec-bg-sidebar">
			<div id="sidebar" class="sidebar ec-sidebar-footer">
				...
				<div class="ec-brand">
					<a href="index.php" title="Vestido">
						<img class="ec-brand-icon" src="assets/img/logo/vest.png" alt="" />
						<!-- <span class="ec-brand-name text-truncate">ESTIDO</span> -->
					</a>
				</div>
				...
				<div class="ec-navigation" data-simplebar>
					...
					<ul class="nav sidebar-inner" id="sidebar-menu">
						...
						<li>
							<a class="sidenav-item-link" href="query-list.php">
