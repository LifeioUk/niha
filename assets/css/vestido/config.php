...
define('DB_USER', "dataqwxc_vestido"); // database user name eg. root
define('DB_DATABASE', "dataqwxc_vestido"); //database name
define('DB_PASSWORD', "dataqwxc_vestido"); //database user password
