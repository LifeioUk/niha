...
$stmt1 = $admin->ret("SELECT COUNT(*) as count FROM `category`");
$result1 = $stmt1->fetch(PDO::FETCH_ASSOC);


$stmt2 = $admin->ret("SELECT COUNT(*) as count FROM `product`");
$result2 = $stmt2->fetch(PDO::FETCH_ASSOC);



$stmt3 = $admin->ret("SELECT COUNT(*) as count FROM `queries`");
...
<head>
	...
	<title>vestido - Admin index.</title>
					...
					<div class="row">
						<div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
							<div class="card card-mini dash-card card-1">
								<div class="card-body">
									<h2 class="mb-1"><?php echo $result1['count']; ?></h2>
									<p>Categories</p>
						...
						<div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
							<div class="card card-mini dash-card card-2">
								<div class="card-body">
									<h2 class="mb-1"><?php echo $result2['count']; ?></h2>
									<p>Products</p>
						 ...
						 <div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
							<div class="card card-mini dash-card card-3">
								<div class="card-body">
									<h2 class="mb-1"><?php echo $result3['count']; ?></h2>
									<p>Queries</p>
