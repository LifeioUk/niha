                                ...
                                <div class="tab-content" id="productTabContent">
                                    <div class="tab-pane fade show active" id="grid-tab-pane" role="tabpanel" aria-labelledby="grid-tab" tabindex="0">
                                        <div class="row">
                                            <?php
                                            if ($categoryid == 'All') {
                                                $stmt = $admin->ret("SELECT * FROM `product` inner join `category` where product.p_id=category.c_id and  product.p_status = 'Active'");
                                                                    ...
                                                                    <form action="https://wa.me/?text=I'm%20inquiring%20about%20the%20apartment%20listing" target="_blank" method="GET">
                                                                        <div class="tp-product-details-wrapper">
                                                                            ...
                                                                            <div class="tp-product-details-action-wrapper">
                                                                                ...
                                                                                <a style="background-color: #000000; text-align: center; display: block;cursor: pointer;" class="tp-product-details-buy-now-btn w-100" onclick="orderNow('<?= $products['p_id'] ?>', '<?= $products['p_name'] ?>', 
...
17 -145 0 -147 0 -156 -24z" fill="currentColor" />
    ...
    <script>
        function redirectToWhatsApp(productName, productID) {
            ...
            const link =  `https://www.dataqueuesystems.com/vestido/productpage.php?product=${productName}`;
