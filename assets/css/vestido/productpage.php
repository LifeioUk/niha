...
if (isset($_GET['product'])) {
   ...
   $stmt = $admin->ret("SELECT * FROM `product` inner join  `category` on product.c_id=category.c_id WHERE product.p_id = $productid");
...
<meta property="og:image" content="https://www.dataqueuesystems.com/vestido/controller/<?= $product['p_image1']; ?>" />
               ...
               <div class="col-xxl-12">
                  <div class="breadcrumb__content p-relative z-index-1">
                     <div class="breadcrumb__list has-icon">
                        ...
                        <span><a href="#" onclick="window.history.back();">Home</a></span>
                        <span><a href="products.php?category=<?= $product['c_id']; ?>"><?= $product['c_name']; ?></a></span>
               ...
               <div class="row">
                     ...
                     <div class="tp-product-details-thumb-wrapper tp-tab d-sm-flex" style="display:flex;flex-direction:column-reverse;gap:5px;">
                        <nav>
                           <div class="nav nav-tabs flex-sm-row " id="productDetailsNavThumb" role="tablist" style="display:flex;gap:5px;flex-wrap: nowrap">
                              ...
                              <?php if ($product['p_image2'] !== 'uploads/products/') : ?>
                              ...
                              <?php endif; ?>
                              <?php if ($product['p_image3'] !== 'uploads/products/') : ?>
                              ...
                              <?php endif; ?>
                              <?php if ($product['p_image4'] !== 'uploads/products/') : ?>
                              ...
                              <?php endif; ?>
                              <?php if ($product['p_image5'] !== 'uploads/products/') : ?>
                  ...
                  <div class="col-xl-5 col-lg-6">
                     <div class="tp-product-details-wrapper">
                        ...
                        <h3 class="tp-product-details-title"><?= $product['p_name']; ?></h3>
                        ...
                        <!-- price -->
                        <?php
                        $colorCodes = explode(',', $product['p_color']);

                        if (!empty($colorCodes) && $colorCodes[0] !== '') {
                           $uniqueId = 'selected_color_' . $product['p_id'];
                        ?>
                        ...
                        <div class="tp-product-details-action-wrapper">
                           ...
                           <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                              <div class="tp-product-details-quantity">
                                 <div class="tp-product-quantity mb-15 mr-15">
                                    ...
                                    <input class="tp-cart-input" type="text" value="1" name="qty_<?= $product['p_id'] ?>">
                           ...
                           <a style="background-color: #000000; text-align: center; display: block;cursor: pointer;" class="tp-product-details-buy-now-btn w-100" onclick="orderNow('<?= $product['p_id'] ?>', '<?= $product['p_name'] ?>', <?= isset($uniqueId) ? "document.getElementById('$uniqueId').value" : "''" ?>)">
...
17 -145 0 -147 0 -156 -24z" fill="currentColor" />
                        ...
                        <script>
                           ...
                           async function orderNow(productId, productName, selectedColor) {
                              ...
                              const link = await `https://www.dataqueuesystems.com/vestido/productpage.php?product=${productId}`;
                              let colorName = '';
         ...
         <div class="container">
            <div class="row">
               <div class="tp-section-title-wrapper-6 text-center mb-40">
                  <span class="tp-section-title-pre-6">Similar Products</span>
               ...
               <div class="tp-product-related-slider">
                  <div class="tp-product-related-slider-active swiper-container  mb-10">
                     <div class="swiper-wrapper">
                        ...
                        <?php 
                        $cid = $product['c_id'];
                        $stmt2 = $admin->ret("SELECT * FROM `product` where c_id = $cid");
                                  while($relatedproducts = $stmt2->fetch(PDO::FETCH_ASSOC)){
                                    if ($relatedproducts['p_id'] !== $product['p_id']) {
                         ?>
                        <div class="swiper-slide">
                           <div class="tp-product-item-3 tp-product-style-primary mb-50">
                              <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                 <a href="productpage.php?product=<?= $relatedproducts['p_id'];?>">
                                    <img src="controller/<?= $relatedproducts['p_image1'];?>" alt="">
                                 </a>
                              ...
                              <div class="tp-product-content-3">
                                 ...
                                 <h3 class="tp-product-title-3">
                                    <a href="productpage.php?product=<?= $relatedproducts['p_id'];?>"><?= $relatedproducts['p_name'];?></a>
                                 </h3>
