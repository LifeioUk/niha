                                    ...
                                    <div class="col-xl-5 col-lg-6 col-md-6">
                                       <div class="tp-history-wrapper pr-45">
                                          <div class="tp-history-content mb-40">
                                             ...
                                             <p>Welcome to Vestido, your ultimate destination for curated fashion and style. At Vestido, we believe that clothing and accessories are not just garments; they are expressions of individuality and confidence. Our platform is dedicated to bringing you a handpicked selection of branded items that embody the perfect blend of quality, trendiness, and uniqueness.</p>
                                             <p>Founded with a passion for fashion, Vestido is more than just an online store – it's a statement. Our team of dedicated curators scours the world of fashion to bring you a diverse range of clothing, shoes, accessories, and more. From the latest runway trends to timeless classics, we meticulously select each item to ensure it meets the high standards of quality and style that we stand for.</p>
                     <p>Thank you for joining us on this fashion journey. We look forward to helping you redefine your style, one exquisite piece at a time</p>
                                          </div>
                                    ...
                                    <div class="col-xl-7 col-lg-6 col-md-6">
                                       <div class="tp-history-thumb-wrapper ml-150 p-relative">
                                          ...
                                          <div class="tp-history-thumb m-img">
                                             <img src="assets/img/logo/logob.png" alt="">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
         ...
         <section class="tp-work-area pt-115 pb-120">
            <div class="container">
               <div class="row justify-content-center">
                  <div class="col-xl-6">
                     <div class="tp-work-section-title-wrapper text-center mb-60 tp-history-year">
                     
                                             <p style="font-size:25px;color:#000000;line-height: 1">DISCOVER YOUR PERFECT STYLE WITH VESTIDO.</p>
                                          <!-- </div>s
                        <h3 class="tp-work-section-title">Discover Your Perfect Style with  <br>Vestido</h3> -->
                     </div>
                  </div>
               </div>
               <div class="row">
